                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$tanggal;?></td>
                                                <td>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editbarang<?=$id_barang;?>">
                                                <i class='far fa-edit'></i>
                                                </button>
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletebarang<?=$id_barang;?>">
                                                <i class='fas fa-eraser'></i>
                                                </button>
                                                </td>
                                            </tr>
                                            <!-- Modal Edit -->
                                            <div class="modal fade" id="editbarang<?=$id_barang;?>">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <input type="text" name="nama_brg" value="<?=$nama_brg;?>" class="form-control">
                                                            <br>
                                                            <input type="text" name="type_brg" value="<?=$type_brg;?>" class="form-control">
                                                            <br>
                                                ...
                                                <!-- Modal Hapus -->
                                                <div class="modal fade" id="deletebarang<?=$id_barang;?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                        <div class="modal-body">
                                                            Apakah anda yakin ingin menghapus <?=$nama_brg;?>?
                                                            <br>
                                                            <br>
                                                            <input type="hidden" name="id_barang" value="<?=$id_barang;?>" >
